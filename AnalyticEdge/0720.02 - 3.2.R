toyota <- read.csv("C:/Users/Nas/Documents/R/ToyotaCorolla.csv")
toyota[1:3,]
summary(toyota)
hist(toyota$Price)
...
me   # mean error
rmse # root mean square error
mape # mean absolute percent error 9.53%
...
me   # mean error
rmse # root mean square error
mape # mean absolute percent error 12.316%
...
abline(m12$coeff[1],m12$coeff[2],dots)
abline(m12$coeff[1],m12$coeff[2],lwd=2)
